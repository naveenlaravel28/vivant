...
class ReportController extends Controller
{
    public function index(Request $request) {
        ...
        return view('admin/report/index', compact('page_title', 'packings', 'customers', 'allPackings', 'dcNo', 'customer', 'date_from', 'date_to'));
    }
    ...
    public function changeStatus($id)
    {
        ...
        if ($validator->fails()) {
            return redirect()->route('admin.report.list')->with('error', $validator->messages()->first());
        }
        ...
        return redirect()->route('admin.report.list')->with('success', 'Order approved successfully!');
    }
    ...
    public function emailPdf($id)
    {
        ...
        return redirect()->route('admin.report.list')->with('success', 'Pdf sent successfully!');
    }
    ...
    public function print($id)
    {
        ...
        return view('admin.report.print', compact('packing', 'pakingDetails', 'customer', 'admin', 'logo'));
    }
}
